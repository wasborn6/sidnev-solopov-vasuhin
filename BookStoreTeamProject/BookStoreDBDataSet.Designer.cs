...
namespace BookStoreTeamProject {
    ...
    public partial class BookStoreDBDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BooksRow AddBooksRow(string Name, string Author, int Price) {
...
namespace BookStoreTeamProject.BookStoreDBDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Books` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` " +
                "= ?)) AND ((? = 1 AND `Author` IS NULL) OR (`Author` = ?)) AND ((? = 1 AND `Pric" +
                "e` IS NULL) OR (`Price` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Books` (`Name`, `Author`, `Price`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Books` SET `Name` = ?, `Author` = ?, `Price` = ? WHERE ((`ID` = ?) AND ((" +
                "? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Author` IS NULL) OR " +
                "(`Author` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BookStoreTeamProject.Properties.Settings.Default.BookStoreDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Author, Price FROM Books";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Author, global::System.Nullable<int> Original_Price) {
        ...
        public virtual int Insert(string Name, string Author, global::System.Nullable<int> Price) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Author, global::System.Nullable<int> Price, int Original_ID, string Original_Name, string Original_Author, global::System.Nullable<int> Original_Price) {
            if ((Name == null)) {
